<template>
  <el-form ref="formRef" class="form-render" :label-width="state.formDesign.options.labelWidth"
    ...
    :status-icon="state.formDesign.options.statusIcon" :inline="state.formDesign.options.inline"
    :size="state.formDesign.options.size" :model="state.formData">
    <form-render-item v-model="state.formData.root" class="root" :component="state.formDesign.component"
      :items="state.formDesign.items" :options="state.formDesign.options" path="root" />
